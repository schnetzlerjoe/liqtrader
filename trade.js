...
const main = async (action, orca, connection) => {
  ...
  if(Number(atokenAmount) > 1 && action == "sell") {
  ...
  } else if (Number(btokenAmount) > 1 && action == "buy") {
...
await main(process.argv[2], orca, connection)
